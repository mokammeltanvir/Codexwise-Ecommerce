                ...
                <div class="card-body">
                    <form action="{{ route('coupon.update', $coupon->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" value="{{ $coupon->discount_amount }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" value="{{ $coupon->minimum_purchase_amount }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="validity_till" value="{{ $coupon->validity_till }}"
                        ...
                        <div class="mb-3 form-check form-switch">
                            <input class="form-check-input" name="is_active" type="checkbox" role="switch"
                                id="activeStatus" @if ($coupon->is_active) checked @endif>
