                    ...
                    <form action="{{ route('products.update', $product->slug) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" name="product_stock" min="0"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror"
                                    id="short_description" id="" cols="30" rows="5">{{ $product->short_description }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="long_description" class="form-control @error('long_description') is-invalid @enderror"
                                    id="long_description" id="" cols="30" rows="5">{{ $product->long_description }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="additional_info" class="form-control @error('additional_info') is-invalid @enderror"
                                    id="additional_info" id="" cols="30" rows="5">{{ $product->additional_info }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="file" class="form-control dropify" name="product_image"
                                    data-default-file="{{ asset('uploads/product_photos') }}/{{ $product->product_image }}">
                                @error('product_image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
